...
def get_possible_nrs(n):
    ...
    for x in range(2, 9):
        for i in range(0, 10):
            if x != 9:
                possible_nrs_for_juliet.append(possible_nr[: x] + str(i) + possible_nr[x:])
                possible_nr = n
            else:
                possible_nrs_for_juliet.append(possible_nr + str(i))
    ...
    return list(dict.fromkeys(possible_nrs_for_juliet)) #converts possible_nrs_for_juliet to a dictionnairy to remove duplicates
...
"""['0779266313', '0789266313', '0796266313', '0792566313', '0792646313', '0792696313', '0792663313', '0792663113', '0792663213']"""